...
namespace ShopCartTestHarness
{
    class Program
    {
        ...
        {
            System.ServiceModel.ChannelFactory<GreatCall.ShoppingCart.Contracts.Services.ICartService> factory = 
                new System.ServiceModel.ChannelFactory<GreatCall.ShoppingCart.Contracts.Services.ICartService>("CartServiceDev6");
            GreatCall.ShoppingCart.Contracts.Services.ICartService cartservice = factory.CreateChannel();
